...
9. Give the stochastic BF model a finite positive-variance witness. Keep smoothing, tail selections, the minimum standard-error rule and correlation assessments as definitions.
