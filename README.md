...
Four hundred and seventy-nine declarations are audited as of 2026-08-25. The library covers Mack chain-ladder variance, Munich paid/incurred reserving, stochastic ODP moments and prediction error, weighted Mack 1999 results, calendar-year CDR, Röhr horizon formulas, Bühlmann-Straub credibility, Bornhuetter-Ferguson prediction error, and Panjer recursion. [ROADMAP.md](ROADMAP.md) records the remaining distributional and approximation boundaries.
...
| Munich coupled projection reduces to separate chain ladder at zero correlation | `munichProjection_zero` | theorem |
