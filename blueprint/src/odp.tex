...
\cite{RenshawVerrall1998}, put the run-off triangle in incremental
...
IBNR claims reserves} \cite{Mack1991}, starts from the same
...
the secondary literature: England and Verrall \cite[Section 2.3]{EnglandVerrall2002}
and W\"uthrich and Merz \cite[Section 2.3]{WuthrichMerz2008}. The displayed equations of Renshaw and
...
family of Mack \cite[Section 2]{Mack1991}, and the row score equation of Renshaw and Verrall
\cite[Section 3]{RenshawVerrall1998}. No hypothesis is needed.
\end{theorem}
\begin{proof}\leanok
...
marginal-sum family of Mack \cite[Section 2]{Mack1991}, and the column score equation of Renshaw
and Verrall \cite[Section 3]{RenshawVerrall1998}.
\end{theorem}
\begin{proof}\leanok
...
Mack \cite[Section 2]{Mack1991} states the converse: the marginal-sum estimates of the
