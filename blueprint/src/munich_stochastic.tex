...
\]
The PIU predicate states independence of the finite $n$ accident years after
grouping each year's paid and incurred histories through the final modeled
period $n-1$.
\end{definition}
...
slope $\lambda^I$.  Both predicates range over adjacent periods satisfying
$k+1<n$.
\end{definition}
...
\begin{theorem}[Zero residual slopes recover separate chain ladder]\label{thm:munichZero}\lean{VerifiedReserving.mclAdjustedPaidFactor_zero, VerifiedReserving.mclAdjustedIncurredFactor_zero, VerifiedReserving.munichProjection_zero}\leanok
