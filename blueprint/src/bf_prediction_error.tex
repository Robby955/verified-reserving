...
\begin{definition}[Random BF estimate and MSEP]\label{def:bfRandomEstimate}\lean{VerifiedReserving.bfStochasticReserveEstimate, VerifiedReserving.meanSquaredPredictionError, VerifiedReserving.BFObservedPredictionIndependence}\leanok
...
\begin{definition}[Raw pattern estimator and practical assessments]\label{def:bfAssessments}\lean{VerifiedReserving.RandomTriangle.bfYRawRv, VerifiedReserving.bfYRaw, VerifiedReserving.bfSigma2Raw, VerifiedReserving.bfYStdErrSq, VerifiedReserving.bfZStdErrSq, VerifiedReserving.bfProcessErrorEstimate, VerifiedReserving.bfEstimationErrorEstimate, VerifiedReserving.bfMsepEstimate, VerifiedReserving.bfCovarianceApprox}\leanok
...
\begin{theorem}[Raw-pattern moments and assessment algebra]\label{thm:bfTotalCovariance}\lean{VerifiedReserving.integral_bfYRawRv, VerifiedReserving.variance_bfYRawRv, VerifiedReserving.bfMsepEstimate_eq, VerifiedReserving.covariance_mul_mul_of_pair_indep}\leanok
\uses{def:bfAssessments}
For known volumes and a nonzero total volume, BF2 and BF3 give the raw
development-proportion estimator mean $y_k$ and variance
$\sigma_k^2/\sum_i x_i$. This is the exact equality behind equation (6) before
the selected, smoothed pattern is substituted for the raw estimator.
