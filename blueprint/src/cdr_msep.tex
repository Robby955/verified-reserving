...
Merz and Wüthrich, \emph{Modelling the claims development result for solvency purposes}
\cite{MerzWuethrich2008}, quantify the uncertainty of the
...
$(C_{I-j,j}/S^{I+1}_j)^2$. No interval bound is claimed for general real-valued triangles.
\end{definition}
...
run-off cell by $C_{I-j,j}/S^{I+1}_j$. No interval bound is claimed without additional sign
hypotheses.
\end{theorem}
\begin{proof}\leanok
...
The aggregated prospective estimator differs from the aggregated retrospective one by
