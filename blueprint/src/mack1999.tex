...
\begin{definition}[Mack 1999, equation $(*)$]\label{def:msepW}\lean{VerifiedReserving.mackTermW, VerifiedReserving.msepW}\leanok
...
\uses{def:mwRec, def:msepW, lem:mwStep, lem:mwChat}
...
vanish, $E[\hat f_k \mid \mathcal{D}_k] = f_k$ for every natural-number exponent $\alpha$. This is
