...
parameter error'' --- together with the two parts in the form above. The paper's
claims-development-result formulas between two arbitrary future horizons are not formalized
here, and neither is its own aggregation over accident years.
